...
Thread/Runnable 机制是不允许抛出Checked异常的；如果抛出了Unchecked异常，会自动去寻找线程的异常处理器进行处理，参见 [Learning Java Concurrency - Thread & Runnable](./2016-04-11-learning-java-concurrency-thread-runnable/index.md) 里面关于线程异常处理的部分。
