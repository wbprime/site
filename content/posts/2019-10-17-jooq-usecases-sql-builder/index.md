...
- [SQL:1999][sql99]
    ...
    ```sql
    update user set name = 'Elvis Wang',
        created_at = timestamp '2019-10-17 18:39:46.222'
    ```
...
- [H2][h2]
    ...
    ```sql
    update user set name = 'Elvis Wang',
        created_at = timestamp '2019-10-17 18:39:46.252'
    ```
...
- [HSQLDB][hsqldb]
    ...
    ```sql
    update user set name = 'Elvis Wang',
        created_at = timestamp '2019-10-17 18:39:46.255'
    ```
...
- [MySQL][mysql]
    ...
    ```sql
    update user set name = 'Elvis Wang',
        created_at = {ts '2019-10-17 18:39:46.258'}
    ```
...
- [Postgres][postgresql]
    ...
    ```sql
    update user set name = 'Elvis Wang',
        created_at = timestamp '2019-10-17 18:39:46.26'
    ```
